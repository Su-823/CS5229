...
N_CLASSES = 20
DATA_DIR = './datasets/OURS'
LIST_PATH = './datasets/OURS/list/val.txt'
DATA_ID_LIST = './datasets/OURS/list/val_id.txt'
with open(DATA_ID_LIST, 'r') as f:
    NUM_STEPS = len(f.readlines()) 
RESTORE_FROM = './checkpoint/LIP_pgn'
...
def main():
    ...
    with tf.name_scope("create_inputs"):
        reader = TestImageReader(DATA_DIR, LIST_PATH, DATA_ID_LIST, None, False, False, False, coord)
        image = reader.image
